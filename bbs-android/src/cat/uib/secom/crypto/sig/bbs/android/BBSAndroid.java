...
public class BBSAndroid extends GeneralPerformanceActivity {
	
	protected static String TAG = "bbs-performance";
	
	protected static String RELATIVE_PATH = "/bbs_performance/";
	
	protected static String FILE_NAME_SIGN = "sign";
	
	protected static String FILE_NAME_VERIFY = "verify";
	...
	protected Integer ITERATIONS = 2;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bbsandroid);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_bbsandroid, menu);
        return true;
    }
	...
	protected void process(boolean precomputation) {
		try {
			bbsSignLog = new BBSLogFile(path, FILE_NAME_SIGN + "_" + precomputation+".csv");
	    	bbsVerifyLog = new BBSLogFile(path, FILE_NAME_VERIFY + "_" + precomputation + ".csv");
